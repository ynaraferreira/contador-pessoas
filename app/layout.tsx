        ...
        <nav className="bg-slate-900/70 backdrop-blur-xl border-b border-slate-800 sticky top-0 z-50 shadow-lg">
          <div className="max-w-5xl mx-auto px-6 h-16 flex items-center gap-10">
            ...
            <div className="flex items-center gap-8 text-lg">
              <Link href="/contador" className="text-slate-300 hover:text-white transition font-medium">
                Contador
              </Link>

              <Link href="/relatorios" className="text-slate-300 hover:text-white transition font-medium">
                Relatórios
              </Link>
            </div>

            <Link className="ml-auto text-red-400 hover:text-red-300 font-medium" href="/logout">
              Sair
            </Link>
